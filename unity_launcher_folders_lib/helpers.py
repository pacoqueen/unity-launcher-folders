...
from . unity_launcher_foldersconfig import get_data_file
...
def get_builder(builder_file_name):
    ...
    builder = Builder()
    builder.set_translation_domain('unity-launcher-folders')
...
def set_up_logging(opts):
    ...
    lib_logger = logging.getLogger('unity_launcher_folders_lib')
...
def get_help_uri(page=None):
    ...
    if not os.path.exists(help_uri):
        ...
        help_uri = 'unity-launcher-folders'
